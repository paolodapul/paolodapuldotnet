export default function Maintenance() {
  return (
    <article className="prose text-slate-700 font-inter_regular container px-10 my-48 md:mx-auto lg:mx-auto sm:w-3/5 sm:mx-auto lg:w-2/5 2xl:w-2/5 text-lg subpixel-antialiased">
      <p className="mb-2">
